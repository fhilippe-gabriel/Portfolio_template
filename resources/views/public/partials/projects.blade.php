        ...
        <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
            ...
            <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:space-y-0 lg:gap-x-6">
                <div class="group relative">
                    ...
                    <p class="text-base font-semibold text-gray-100">Nisi ea nulla irure eiusmod duis deserunt proident
                        commodo pariatur proident non consectetur proident cupidatat.
